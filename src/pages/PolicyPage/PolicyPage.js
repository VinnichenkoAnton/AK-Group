  ...
  return (
    <>
      <Helmet>
        <meta
          name="description"
          content="Cторінка Політика щодо обробки персональних даних сайту AK GROUP INSURANCE BROKERS. AK GROUP INSURANCE BROKERS - охоронная компанія для фізичних осіб та організацій в с.Гатне"
        />
        ...
        <section className={classes.policy}>
          <Container>
            ...
            <p className={classes.policy__li}>
              ...
              себе AK GROUP INSURANCE BROKERS (далі - Оператор).
            </p>
            ...
            <h3 className={classes.policy__subtitle}> 7. Мета обробки персональних даних</h3>
            <div className={classes.policy__ol}>
              <div className={classes.policy__li}>
              ...
              <div className={classes.policy__li}>
                ...
                адресу електронної пошти info@ak-group.net з позначкою «Відмова від повідомлень про
                нові продукти, послуги та спеціальні пропозиції».
              </div>
              <div className={classes.policy__li}>
            ...
            <div className={classes.policy__ol}>
              ...
              <div className={classes.policy__li}>
                ...
                електронної пошти Оператора info@ak-group.net з позначкою «Актуалізація персональних
                даних».
              </div>
              <div className={classes.policy__li}>
                ...
                на електронну адресу Оператора info@ak-group.net з позначкою «Відкликання згоди на
            ...
            <h3 className={classes.policy__subtitle}>14. Заключні положення</h3>
            <div className={classes.policy__ol}>
              <div className={classes.policy__li}>
                ...
                електронної пошти info@ak-group.net.
              </div>
              <div className={classes.policy__li}>
